...
try {
    ...
    $busUnits = [
        ...
        [
            ...
            'capabilities' => json_encode([
                ...
                ['title' => 'WONTIA AIP', 'desc' => 'Your intelligence layer — understand context, make decisions, execute actions'],
                ['title' => 'WONTIA Food Security', 'desc' => 'Applied intelligence to detect, prioritize, coordinate, and measure impact'],
                ['title' => 'WONTIA IA Annotation Suite', 'desc' => 'AI data annotation at scale: projects, quality, and teams'],
            ]),
            'benefits' => json_encode([
                ['title' => 'One Intelligence Core', 'desc' => 'The same architecture powers every WONTIA product'],
        ...
        [
            ...
            'description'    => 'WONTIA IA Annotation Suite is a comprehensive platform for managing AI data annotation projects at scale. From image and video labeling to text classification and audio transcription, it provides project management, quality control, and workforce optimization tools for annotation teams.',
            'hero_title'     => 'AI Data Annotation Suite',
    ...
    $products = [
        [
            'name'          => 'Wontia AIP',
            'slug'          => 'wontia-aip',            'description'   => 'Wontia is an Applied Intelligence System (AIS) powered by TIA — Technology of Applied Intelligence. It understands context, makes decisions, and executes actions across a growing ecosystem of domain applications: Wontia Business, Web Intelligence, Food Security, and more. Not a CRM — an intelligence layer where CRM is just one capability.',
        ...
        [
            'name'          => 'WONTIA FOOD SECURITY',
            'slug'          => 'wontia-food-security',
            'description'   => 'WONTIA Food Security applies the WONTIA + TIA intelligence core to food security: detect risk, prioritize response, coordinate action, and measure impact.',
            'short_desc'    => 'Applied intelligence for food security. Detect risk, prioritize response, coordinate action, and measure impact.',
            'hero_title'    => 'Food Security Intelligence',
            'hero_subtitle' => 'The same WONTIA intelligence, applied to feeding people better.',
            'icon'          => 'wheat',
            'category'      => 'Food Security',
            'order_num'     => 30,
            'overview'      => '<p>WONTIA Food Security proves that the same architecture can extend beyond business into domains that impact lives. It combines detection, understanding, prioritization, coordination, and action into one measurable response engine.</p><p>From food at risk to communities served, every decision is measured and every outcome feeds back into the system.</p>',
            'problem'       => '<p>Food at risk is lost every day because responses are slow, uncoordinated, and hard to measure. Teams work with disconnected data, manual prioritization, and no clear view of impact.</p>',
            'solution'      => '<p>WONTIA Food Security gives you one engine to detect risk, understand context, prioritize response, coordinate action, and measure impact — with TIA recommending, humans approving, and the platform executing.</p>',
            'features'      => json_encode([
                ['title' => 'Detect', 'desc' => 'Identify food at risk before it is lost'],
                ['title' => 'Understand', 'desc' => 'Context and severity scoring for every situation'],
                ['title' => 'Prioritize', 'desc' => 'TIA ranks responses by impact and urgency'],
                ['title' => 'Coordinate', 'desc' => 'Align teams, logistics, and communities in one plan'],
                ['title' => 'Act', 'desc' => 'Execute approved actions with a full audit trail'],
                ['title' => 'Measure Impact', 'desc' => 'Meals enabled, food saved, communities served'],
            ]),
            'benefits'       => json_encode([
                ['title' => 'Less Food Lost', 'desc' => 'Faster detection and response protect at-risk food'],
                ['title' => 'More Meals Enabled', 'desc' => 'Prioritized coordination turns food into meals'],
                ['title' => 'Measurable Outcomes', 'desc' => 'Every action tracked from detection to impact'],
            ]),
            'use_cases' => json_encode([
                ['title' => 'Redistribution Networks', 'desc' => 'Route at-risk food to communities that need it most'],
                ['title' => 'Emergency Response', 'desc' => 'Coordinate food response across organizations'],
                ['title' => 'Food Programs', 'desc' => 'Measure and optimize food security programs'],
            ]),
            'architecture'   => '<p>WONTIA Food Security runs on the unified WONTIA AIS architecture: AIS Core, TIA intelligence engine, domain knowledge bases, decision engine, action orchestration, and measurable outcomes — with a continuous feedback loop.</p>',
            'roadmap'        => '<ul><li><strong>In development:</strong> Food Security Response Engine</li><li><strong>Next:</strong> More domains on the same core (Health, Agriculture, Industry)</li></ul>',
            'demo_cta_url'   => 'https://wontia.com/#food-security',
            'demo_cta_text'  => 'Visit wontia.com',
        ],
        [
            'name'          => 'WONTIA IA ANNOTATION SUITE',
            ...
            'solution'      => '<p>WONTIA IA Annotation Suite provides a centralized platform where project managers define ontologies, create annotation tasks, monitor quality in real-time, and track annotator performance. Automated QC sampling catches issues early, and the workforce analytics dashboard helps optimize team composition and throughput.</p>',
            'features'      => json_encode([
